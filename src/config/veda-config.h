/* src/config/primestone-config.h.  Generated from primestone-config.h.in by configure.  */
/* src/config/primestone-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PRIMESTONE_CONFIG_H

#define PRIMESTONE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/primestonepay/primestone/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "PrimeStone"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PrimeStone 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "primestonecore"
