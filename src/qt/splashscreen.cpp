    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextPrimeStone   = QChar(0xA9)+QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The PrimeStone developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextPrimeStone);
