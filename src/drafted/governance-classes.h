 ...
 *
 *   // network
 *   CPrimeStoneNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.primestone.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CPrimeStoneNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CPrimeStoneNetwork(UniValue objIn)
    {
...
// // can be under: PrimeStoneNetwork
// //   -- signature requirements : Key1(User)
// class CPrimeStoneNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == PrimeStoneNetwork);
//     // }
