...
{
//    printf("UpdateFromNewBroadcast....mnb.sigTime: %d, sitTime: %d, mnb.fRecovery: %d.............\n", mnb.sigTime, sigTime, mnb.fRecovery);
    if(mnb.sigTime <= sigTime && !mnb.fRecovery) return false;
//    printf("UpdateFromNewBroadCast...........................start..................\n");
...
//    printf("fMasterNode: %d, activeMasternode.pubKeyMasterNode: %d, puKeyMasternode: %d........\n", fMasterNode, activeMasternode.pubKeyMasternode, pubKeyMasternode);
...
//    printf("nProtocolVersion: %d, mnpayments.GetMinMasternodePaymentsProto(): %d, PROTOCOL_VERSION: %d ..............\n", nProtocolVersion, mnpayments.GetMinMasternodePaymentsProto(), PROTOCOL_VERSION);
...
//	printf("fWaitForPing : %d, fOurMasternode: %d ..................................\n", fWaitForPing, fOurMasternode);
...
//	printf("IsPingedWithin(MASTERNODE_EXPIRATION_SECONDS): %d ...............................\n", IsPingedWithin(MASTERNODE_EXPIRATION_SECONDS));
...
bool CMasternodeBroadcast::CheckOutpoint(int& nDos)
{
...

    {
        ...
        if (err == COLLATERAL_INVALID_AMOUNT) {
            LogPrint("masternode", "CMasternodeBroadcast::CheckOutpoint -- Masternode UTXO should have 1000 PSC, masternode=%s\n", vin.prevout.ToStringShort());
            return false;
        }
    ...
    // should be at least not earlier than block when 1000 PSC tx got nMasternodeMinimumConfirmations
    ...
    GetTransaction(vin.prevout.hash, tx2, Params().GetConsensus(), hashBlock, true);
    {
        ...
        if (mi != mapBlockIndex.end() && (*mi).second) {
            CBlockIndex* pMNIndex = (*mi).second; // block for 1000 PSC tx -> 1 confirmation
