...
struct AddedNodeInfo
{
    ...
    CService resolPRIMESTONEddress;
    bool fConnected;
    bool fInbound;
};
...
public:
    ...
    // because it's used in many PrimeStone-specific places (masternode, privatesend).
...
private:
...
#else
    boost::condition_variable condMsgProc;
    boost::mutex mutexMsgProc;
    std::atomic<bool> flagInterruptMsgProc;
    ...
    boost::thread threadMnbRequestConnections;
